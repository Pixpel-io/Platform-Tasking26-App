...
// reply_to self-joins messages via the reply_to_id column (column-name hint,
// not the FK constraint name - PostgREST didn't register the named self-FK
// reliably here). Just the sender + snippet the quote strip needs.
